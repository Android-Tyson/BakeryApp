...
public class Apis {
    ...
    public static final String new_offer_header_slider = BASE_URL + "api/offers?n=3";
    public static final String urgent_cake_header_slider = BASE_URL + "api/offers?n=3";

    public static final String headerImageSlider = BASE_URL + "api/categories";
