...
public class NoticeBoardListAdapter extends RecyclerView.Adapter<NoticeBoardListAdapter.ViewHolder> {
    ...
    public NoticeBoardListAdapter(Context context, List<String> titleList, List<String> infoList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.single_row_notice_board, viewGroup, false);
